<template>
	<view>
		<c-header title="发布寻主"></c-header>
		<view class="c-gutter-md"></view>
		<c-form class="c-form_label-width-md" ref="cForm" :form="formData" :rules="formRules">
			<c-form-item label="拾主名称" required no-border-top>
				<c-input v-model="formData.name" :maxlength="20" placeholder="请输入拾主名称" clear />
			</c-form-item>
			...
			<c-form-item label="拾到位置" required>
